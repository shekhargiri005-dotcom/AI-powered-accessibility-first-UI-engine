...
export const MODEL_REGISTRY: Record<string, ModelCapabilityProfile> = {
  ...
  // ══════════════════════════════════════════════════════════════════════════
  // OLLAMA  (Self-hosted models via OpenAI-compatible API)
  // ══════════════════════════════════════════════════════════════════════════
  ...
  'llama3.2': {
    ...
    strengths: ['good general-purpose model', 'self-hosted privacy', 'no API costs'],
    weaknesses: ['smaller context than cloud models', 'slower inference', 'no JSON mode'],
    promptStrategy: 'guided-freeform',
  ...
  'qwen2.5-coder': {
    ...
    supportsJsonMode: false,
    streamingReliable: false,
    strengths: ['excellent code generation', 'large context', 'self-hosted', 'no API costs'],
    weaknesses: ['no JSON mode', 'slower than cloud', 'may truncate long output'],
    promptStrategy: 'guided-freeform',
    maxBlueprintTokens: 3000,
    needsExplicitImports: true,
    needsOutputWrapper: true,
  ...
  'deepseek-coder': {
    id: 'deepseek-coder',
    displayName: 'DeepSeek Coder (Ollama)',
    provider: 'ollama',
    tier: 'large',
    contextWindow: 16384,
    maxOutputTokens: 8192,
    ...
    supportsJsonMode: false,
    streamingReliable: false,
    strengths: ['strong code generation', 'good UI layout understanding', 'self-hosted'],
    weaknesses: ['no JSON mode', 'may wrap code in markdown fences', 'slower inference'],
    promptStrategy: 'guided-freeform',
    maxBlueprintTokens: 3000,
    needsExplicitImports: true,
    needsOutputWrapper: true,
  ...
  'phi4': {
    ...
    supportsJsonMode: false,
    streamingReliable: false,
    strengths: ['very small and fast', 'good for simple components', 'self-hosted'],
    weaknesses: ['tiny context window', 'limited code quality', 'frequent truncation'],
    promptStrategy: 'structured-template',
    maxBlueprintTokens: 1000,
    needsExplicitImports: true,
    needsOutputWrapper: true,
    extractionStrategy: 'aggressive',
    repairPriority: 'never',
    timeoutMs: 45000,
  },
  ...
  'mistral': {
    ...
    streamingReliable: false,
    strengths: ['good general-purpose model', 'self-hosted privacy', 'no API costs'],
    weaknesses: ['weaker code quality than Qwen Coder', 'smaller context', 'no JSON mode'],
    promptStrategy: 'guided-freeform',
    maxBlueprintTokens: 2000,
    needsExplicitImports: true,
    needsOutputWrapper: true,
