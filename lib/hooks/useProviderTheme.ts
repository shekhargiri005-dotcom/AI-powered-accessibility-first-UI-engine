...
const THEMES: Record<string, ProviderTheme> = {
  ...
  anthropic: {
    ...
    shadowGlow: 'shadow-amber-500/60',
    gradient: 'from-amber-500 to-orange-600',
    gradientSubtle: 'from-amber-500/10 to-orange-500/5',
    radialOrb: 'rgba(245,158,11,0.10)',
    radialOrbMid: 'rgba(245,158,11,0.03)',
    scrollbar: 'bg-amber-500/10',
    scrollbarHover: 'bg-amber-500/30',
  },
  google: {
    name: 'Google',
    accent: 'blue',
