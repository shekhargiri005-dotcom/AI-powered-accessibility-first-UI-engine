...
export function BarChart({ data, className = '' }: { data: { value: number; [key: string]: unknown }[]; className?: string }) {
  return (
...
export function LineChart({ data, className = '' }: { data: unknown[]; className?: string }) {
...
export function PieChart({ data: _data, className = '' }: { data: unknown[]; className?: string }) {
